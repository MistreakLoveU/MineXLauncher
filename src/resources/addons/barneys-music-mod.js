...
playButton.style.fontFamily = 'Poppins,
 sans-serif';
...
playButton.addEventListener('click',
 ...
 -50%)';
    ...
    modal.style.boxShadow = '0 0 10px rgba(0,
 0,
 0,
 0.5)';
 ...
 sans-serif';
    ...
    songNameInput.setAttribute('type',
 'text');
    ...
    songNameInput.style.fontFamily = 'Poppins,
 sans-serif';


    songNameInput.addEventListener('click',
 function() {
    ...
    musicUrlInput.setAttribute('type',
 'text');
    ...
    musicUrlInput.style.fontFamily = 'Poppins,
 sans-serif';


    musicUrlInput.addEventListener('click',
 function() {
    ...
    addButton.style.fontFamily = 'Poppins,
 sans-serif';
