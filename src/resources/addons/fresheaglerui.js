      ...
      if (ModAPI.mcinstance.$currentScreen != null) {
          ...
          if(ModAPI.mcinstance.$currentScreen.$guiTop != null){
              ...
              if(!invAnimDone){
                  ...
                  slideInYGui(ModAPI.mcinstance.$currentScreen,
0,
ModAPI.mcinstance.$currentScreen.$guiTop,
invAnimSpeed)
                  invAnimDone = true;
...
drawHudThings);
  ...
  var interv = setInterval(setIntervalThings,
16);
