...
var GrappleHookMod = {
 ...
 0,
 0],
 //The previous hook position.
  prev: "NONE",
 //The previous state
  scaleH: 0.25,
 //Used for X and Z velocity
  scaleV: 0.15,
 //((Grapple Y) minus (Player Y)) times scaleV
  lift: 0.4,
...
ModAPI.addEventListener("update",
 ...
 //Multiply by horizontal scale
      my *= GrappleHookMod.scaleV;
 //Multiply by vertical scale
 ...
 //If the hook exists,
 but the previous state was NONE,
 update the state.
