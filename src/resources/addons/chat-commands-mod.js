...
§3.spawn §6\| §aAttempts to set player coordinates to 0,
 0
...
message: 'My current date and time is [ '+d+' ]'
})
 ...
 5);
        ...
        e.preventDefault = true
        ModAPI.player.sendChatMessage({
message: 'My current position is [ ' + Math.floor(ModAPI.player.x) + ',
 ...
 ' + Math.floor(ModAPI.player.z) + ' ] '
        ...
        e.preventDefault = true
        ModAPI.displayToChat({
msg: '§3Bug report: §b'+e.message.substr(11)
})
...
msg: '§3Position set!'
 ...
 100);
        ...
        e.preventDefault = true
        ModAPI.displayToChat({
msg: '§6[§4ERROR§6] §cThis command requires a string'
})
...
msg: '§3Replaying lo-fi'
        ...
        try {
            ...
            ModAPI.displayToChat({
msg: '§3Volume set to '+ e.message.substr(8)
})
        
} catch (error) {

            ModAPI.displayToChat({
msg: "§6[§4ERROR§6] §c"+error
})
        ...
        ModAPI.displayToChat({
msg: '§3URL was set to §6[ §b' + e.message.substr(9) + ' §6]'
})
        ...
        e.preventDefault = true
        ModAPI.displayToChat({
msg: '§6[§4ERROR§6] §cThis command requires a URL'
})
        ...
        ModAPI.displayToChat({
msg: '§3Loop is now set to §6[ §a'+loopToggle+' §6]'
})
        ...
        e.preventDefault = true
        ModAPI.displayToChat({
msg: '§6[§4ERROR§6] §cNo such command,
