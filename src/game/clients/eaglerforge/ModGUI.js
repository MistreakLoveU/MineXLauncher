...
";
    ...
    closeButton.style = `margin-left: 2rem;
 color: red;
`;
 ...
 () => {
    ...
    warningPoster.style = "font-size: 0.8rem;
 color: orangered;
";
    ...
    tipPoster.style = "font-size: 0.8rem;
 color: yellow;
";

    tipPoster.innerHTML =
      "Tip: if the mods say that they failed loading,
 try refreshing the gui";
 ...
 width: 100%";
    ...
    headerRow.style = "background: rgb(50,
50,
50);
";
...
";
      ...
      textWrapper.style = `max-width: 100%;
...
";
        ...
        case "FAILED":
          statusBox.style = "background-color: dimgrey;
 text-align: center;
";
...
";
 ...
 () => {
      ...
      var newMod = window.prompt("URL of Mod: ",
...
";
 ...
 function onModRead() {
            ...
            var newMod = reader.result.replace(";
base64",
 `;
fs=${
