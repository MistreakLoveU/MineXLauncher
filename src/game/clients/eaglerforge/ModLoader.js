function loadLoader() {
 ...
 ModsArr.length);
    ...
    function checkModsLoaded(totalLoaded,
 identifier) {
          ...
          ModAPI.events.callEvent("load",
 {
    ...
    function methodB(currentMod) {
      ...
      try {
        ...
        script.setAttribute("data-Mod",
 currentMod);

        script.setAttribute("data-isMod",
 true);
...
" + encodeURIComponent(req.responseText);
