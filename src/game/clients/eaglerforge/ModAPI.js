function initAPI(version) {
 ...
 "event": [] 
  ...
  ModAPI.addEventListener = function AddEventListener(name,
 callback) {
  ...
  ModAPI.removeEventListener = function removeEventListener(name,
 func,
 slow) {
    ...
    if (!slow) {
      ...
      if (targetArr.indexOf(func) !== -1) {
        ...
        targetArr.splice(targetArr.indexOf(func),
 1);
 ...
 1);
  ...
  ModAPI.events.callEvent = function callEvent(name,
 data) {
