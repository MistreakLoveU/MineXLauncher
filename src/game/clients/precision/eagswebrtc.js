...
window.initializeVoiceClient = (() => {
 ...
 (evt) => {
                ...
                if (evt.candidate) {
                    ...
                    self.client.iceCandidateHandler(self.peerId,
 JSON.stringify({
 ...
 (evt) => {
                ...
                self.client.peerTrackHandler(self.peerId,
 self.rawStream);
 ...
 () => {
                        ...
                        self.client.descriptionHandler(self.peerId,
...
DtlsSrtpKeyAgreement: true
                ...
                const peerInstance = new EaglercraftVoicePeer(this,
 peerId,
 peerConnection,
 offer);

                this.peerList.set(peerId,
 peerInstance);
...
window.initializeLANServer = (() => {
 ...
 0));
                ...
                self.client.remoteClientDataChannelHandler(self.peerId,
 self.dataChannel);

                self.dataChannel.addEventListener("message",
 (evt) => {

                    self.client.remoteClientPacketHandler(self.peerId,
 evt.data);
...
urls: etr[0],
 ...
 credential: etr[2]
        ...
        sendPacketToRemoteClient(peerId,
 buffer) {
...
DtlsSrtpKeyAgreement: true
                ...
                const peerInstance = new EaglercraftLANPeer(this,
 peerId,
 peerConnection);
 ...
 peerInstance);
        ...
        signalRemoteDescription(peerId,
 descJSON) {
        ...
        signalRemoteICECandidate(peerId,
 candidate) {
